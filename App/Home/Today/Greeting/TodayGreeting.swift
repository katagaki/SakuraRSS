...
struct TodayGreeting {
    ...
    private static let anchors: [(h: Double, stops: GradientStops)] = [
        // 0 to 4:59 night, anchor 02:30: deep purple to deep blue
        (2.5, GradientStops(
            top: SIMD3(0.28, 0.14, 0.50),
            bottom: SIMD3(0.08, 0.14, 0.40)
        )),
        // 5 to 11:59 morning, anchor 08:30: dusty purple to warm gold (white-text safe)
        (8.5, GradientStops(
            top: SIMD3(0.55, 0.40, 0.78),
            bottom: SIMD3(0.95, 0.60, 0.25)
        )),
        // 12 to 17:59 afternoon, anchor 14:30: blue to lighter blue
        (14.5, GradientStops(
            top: SIMD3(0.25, 0.55, 0.95),
            bottom: SIMD3(0.62, 0.85, 1.00)
        )),
        // 18 to 20:59 early evening, anchor 19:30: blue to orange (dusk)
        (19.5, GradientStops(
            top: SIMD3(0.30, 0.50, 0.85),
            bottom: SIMD3(1.00, 0.55, 0.20)
        )),
        // 21 to 23:59 evening, anchor 22:00: deep purple to orange (last light)
        (22.0, GradientStops(
