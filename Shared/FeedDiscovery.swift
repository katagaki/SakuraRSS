...
actor FeedDiscovery {
    ...
    private func detectYouTubeChannelFeed(url: URL) async -> DiscoveredFeed? {
    ...
    private static func resolveYouTubeChannelID(from url: URL) async -> String? {
    ...
    private static func fetchYouTubeAtomTitle(feedURL: String) async -> String? {
