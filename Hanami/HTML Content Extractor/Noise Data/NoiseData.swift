...
public enum NoiseData {
    ...
    public static let classPatterns: [String] = loadGroupedList(
        resource: "NoiseClassPatterns",
        key: \GroupedPatterns.groups,
        valueKey: \PatternGroup.patterns
    )

    public static let unsafeInsideArticle: Set<String> = Set(
        loadFlatList(resource: "UnsafeInsideArticle")
    )

    public static let advertisementTextPatterns: Set<String> = Set(
