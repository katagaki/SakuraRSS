...
public struct OpenArticleRequest: Equatable, Sendable {
    ...
    public enum TextMode: String, CaseIterable, Sendable {
        case auto
        case fetch
        case extract
    }
    ...
    public init(url: String, mode: Mode, textMode: TextMode = .auto) {
        self.url = url
        self.mode = mode
