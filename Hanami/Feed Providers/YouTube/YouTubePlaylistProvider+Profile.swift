...
extension YouTubePlaylistProvider: ProfileFeedProvider {
    ...
    public nonisolated static var providerID: String { "youtube-playlist" }

    public nonisolated static var domains: Set<String> { ["youtube.com"] }

    public nonisolated static var feedURLScheme: String? { "youtube-playlist" }
