...
public final class SubstackProvider {
    public nonisolated static func isSubstackHost(_ host: String?) -> Bool {
        matchesHost(host)
    }

    public nonisolated static func isSubstackPublicationHost(_ host: String?) -> Bool {
    ...
    public nonisolated static func isSubstackPublicationURL(_ url: URL) -> Bool {
        isSubstackPublicationHost(url.host)
    }

    public nonisolated static func isSubstackFeedURL(_ urlString: String) -> Bool {
        guard let url = URL(string: urlString),
              isSubstackPublicationHost(url.host) else { return false }
        return url.path.hasSuffix("/feed")
    }

    public nonisolated static func publicationAPIURL(for host: String) -> URL? {
    ...
    public nonisolated static func upgradedImageURL(_ urlString: String) -> String {
    ...
    public nonisolated static func squareCroppedPhotoURL(_ urlString: String) -> String {
    ...
    public func fetchPublication(host: String) async -> SubstackPublicationFetchResult {
