...
public nonisolated enum HackerNewsProvider: RSSFeedProvider {

    public static let host = "news.ycombinator.com"

    public static var providerID: String { "hacker_news" }

    public static let domains: Set<String> = [host]
    ...
    public static func threadURL(fromSummary summary: String) -> URL? {
