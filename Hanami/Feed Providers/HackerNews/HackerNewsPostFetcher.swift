...
public nonisolated enum HackerNewsPostFetcher {
    ...
    public static func isSelfPostURL(_ articleURL: URL) -> Bool {
    ...
    public static func fetchPostText(for articleURL: URL) async throws -> String? {
