...
public nonisolated enum ArXivProvider: RSSFeedProvider, ResearchFeedProvider {

    public static var providerID: String { "arxiv" }

    public static var domains: Set<String> { ["arxiv.org"] }

    public static func matchesFeedURL(_ feedURL: String) -> Bool {
    ...
    public static func extractCategoryFromListURL(_ url: URL) -> String? {
    ...
    public static func feedURL(forCategory category: String) -> String {
        "https://rss.arxiv.org/rss/\(category)"
    }

    // MARK: - Abstract URLs

    public static func isAbstractURL(_ url: URL) -> Bool {
    ...
    public static func extractArXivID(from url: URL) -> String? {
        guard matchesHost(url.host) else { return nil }
        let path = url.path
    ...
    public static func pdfURL(forArticleURL articleURL: String) -> URL? {
