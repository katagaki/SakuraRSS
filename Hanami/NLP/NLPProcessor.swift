...
public nonisolated enum NLPProcessor {

    // MARK: - Hybrid Scoring Tunables

    // Weights should sum to 1.0.
    public static let hybridEmbeddingWeight: Double = 0.65
    public static let hybridEntityWeight: Double = 0.35
    public static let maxEmbeddingDistance: Double = 2.0
    ...
    public static func extractEntities(from text: String) -> [EntityResult] {
    ...
    public static func extractEntities(from text: String, using tagger: NLTagger) -> [EntityResult] {
        guard !text.isEmpty else { return [] }
        tagger.string = text
    ...
    public static func sentimentScore(for text: String) -> Double? {
    ...
    public static func sentimentScore(for text: String, using tagger: NLTagger) -> Double? {
        guard !text.isEmpty else { return nil }
        tagger.string = text
    ...
    public static func findSimilarArticlesHybrid(
        to article: Article,
