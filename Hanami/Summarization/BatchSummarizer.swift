...
public enum BatchSummarizer {

    public static let minArticleBodyCharacters = 200

    /// Returns true when `summary` has enough real content beyond the title to feed the LLM.
    public static func hasUsefulContent(title: String, summary: String?) -> Bool {
    ...
    public static func packBatches(_ descriptions: [String], charLimit: Int) -> [String] {
        var batches: [String] = []
        var current: [String] = []
        var currentLength = 0
