...
public nonisolated enum RedirectDomains: DomainDefaults {

    public static let redirects: [String: String] = [
        "twitter.com": "x.com",
        "rsshub.app": "rsshub.rss3.workers.dev"
    ]

    public static var exceptionDomains: Set<String> { Set(redirects.keys) }

    public static func redirectedURL(_ url: URL) -> URL {
