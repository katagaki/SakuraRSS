...
public nonisolated enum RefreshTimeoutDomains: DomainDefaults {
    ...
    public static var exceptionDomains: Set<String> { Set(timeouts.keys) }
    ...
    public static func refreshTimeout(for feedDomain: String, jittered: Bool = true) -> TimeInterval? {
    ...
    public static func timeoutKey(for feedDomain: String) -> String? {
