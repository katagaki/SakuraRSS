...
public nonisolated enum DisplayStyleSetDomains: DomainDefaults {

    public static let domainStyles: [String: FeedDisplayStyle] = [
        "x.com": .feed,
        "twitter.com": .feed,
        "bsky.app": .feed,
    ...
    public static let exceptionDomains: Set<String> = Set(domainStyles.keys)

    /// Returns the preferred display style for the given domain, or `nil` if none is set.
    public static func style(for feedDomain: String) -> FeedDisplayStyle? {
