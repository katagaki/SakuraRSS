...
public nonisolated final class OPMLManager: @unchecked Sendable {

    public static let shared = OPMLManager()

    private init() {}

    // MARK: - Export

    public func generateOPML(from feeds: [Feed]) -> String {
        var lines: [String] = []
    ...
    public func parseOPML(data: Data) -> [OPMLFeed] {
...
public nonisolated struct OPMLFeed: Sendable {
