...
public nonisolated enum BatchingMode: String, CaseIterable, Identifiable, Sendable {
    case off
    case day1
    case day3
    case week1
    ...
    public var isDateBased: Bool { chunkDays != nil }
    public var isCountBased: Bool { batchSize != nil }
    ...
    public func initialSinceDate(latestArticleDate: Date? = nil) -> Date {
    ...
    public func initialCount() -> Int { batchSize ?? 0 }

    /// Returns the currently persisted mode, with Doomscrolling Mode applied.
    public static func current() -> BatchingMode {
